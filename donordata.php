...
if(isset($_POST['submit']))
{
	...
	foreach ($list=$_POST['list'] as $value) {
		...
		$sql="INSERT INTO register (name,username,password,dob,gender,bg,weight,contact,email,state,city,area,list) VALUES ('$name','$username','$pass','$dob','$gen','$bg','$kgs','$phno','$email','$state','$city','$area','$value')";
